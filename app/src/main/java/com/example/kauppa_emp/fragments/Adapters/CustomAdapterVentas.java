...
public class CustomAdapterVentas extends RecyclerView.Adapter<CustomAdapterVentas.MyViewHolder> {
    ...
    public CustomAdapterVentas(Activity activity, Context context, ArrayList<String> movimiento_id, ArrayList<String> movimiento_fecha,
    ...
    public void onBindViewHolder(@NonNull final MyViewHolder holder, int position) {
        ...
        holder.filaVentas_id_txt.setText(String.valueOf(movimiento_id.get(position)));
        holder.filaVentas_fecha_txt.setText(String.valueOf(movimiento_fecha.get(position)));
        holder.filaVentas_monto_txt.setText(String.valueOf(movimiento_monto.get(position)));
